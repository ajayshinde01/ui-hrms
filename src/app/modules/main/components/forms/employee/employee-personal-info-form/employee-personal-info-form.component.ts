...
import { EmployeePersonalDetailsFormComponent } from '../employee-personal-details-form/employee-personal-details-form.component';
@Component({
...
export class EmployeePersonalInfoFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.minDob= new Date(today.getFullYear() - 80 ,today.getMonth(), today.getDate())
  }
  ...
  fetchStatus() {
    ...
    this.employeeService.getStatus().subscribe((Response: Array<CommonMaster>) => {
  ...
  fetchGender() {
    this.employeeService.getGender().subscribe((Response: Array<CommonMaster>)=>{
  ...
  fetchTitles() {
    this.employeeService.getTitle().subscribe((Response: Array<CommonMaster>) => {
  ...
  selectedTabValue(event: any){
    ...
    this.inputText=event.tab.textLabel;
